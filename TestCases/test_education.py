...
class Test_009_Education():
    ...
    def test_education(self, setup):
        ...
        self.saveeducation = self.driver.find_element_by_css_selector(
            "#content > div > div:nth-child(7) > div.inner > div").text
        self.logger.info("*** Deleting Education ***")
        self.education.SelectAllEducation()
        self.education.ClickOnDeleteEducation()
        self.deleteeducation = self.driver.find_element_by_css_selector(
            "#content > div > div:nth-child(7) > div.inner > div").text
